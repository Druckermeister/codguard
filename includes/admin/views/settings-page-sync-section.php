...
<div class="codguard-settings-section codguard-sync-status-section">
	...
	<div class="codguard-next-sync-info">
		...
		<div class="info-text">
			...
			printf( esc_html__( 'Orders from yesterday will be automatically uploaded to CodGuard at %s.', 'codguard' ), '<strong>' . esc_html( $next_sync ) . '</strong>' );
			?>
			</p>
		</div>
	</div>
	...
	<div class="codguard-info-box" style="margin-top: 20px;">
		...
		<ul style="margin-left: 20px;">
			...
			printf( esc_html__( 'Successful orders (status: %s) are reported as outcome: 1', 'codguard' ), '<code>' . esc_html( $settings['good_status'] ) . '</code>' );
			?>
			</li>
			<li>
			<?php
			/* translators: %s: refused order status name */
			printf( esc_html__( 'Refused orders (status: %s) are reported as outcome: -1', 'codguard' ), '<code>' . esc_html( $settings['refused_status'] ) . '</code>' );
			?>
			</li>
